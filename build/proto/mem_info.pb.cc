...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mem_5finfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::monitor::proto::MemInfo, buffer_),
...
const char descriptor_table_protodef_mem_5finfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\025\n\rinactive_file\030\014 \001(\002\022\r\n\005dirty\030\023 \001(\002\022\021\n"
  "\twriteback\030\024 \001(\002\022\022\n\nanon_pages\030\025 \001(\002\022\016\n\006"
  "mapped\030\026 \001(\002\022\024\n\014KReclaimable\030\027 \001(\002\022\024\n\014sR"
  "eclaimable\030\030 \001(\002\022\022\n\nsUnreclaim\030\031 \001(\002\022\024\n\014"
  "used_percent\030\032 \001(\002b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mem_5finfo_2eproto = {
  &descriptor_table_mem_5finfo_2eproto_initialized, descriptor_table_protodef_mem_5finfo_2eproto, "mem_info.proto", 426,
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 37)) {
          buffer_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else goto handle_unusual;
        continue;
      // float cached = 5;
...
::PROTOBUF_NAMESPACE_ID::uint8* MemInfo::_InternalSerialize(
  ...
  if (!(this->buffer() <= 0 && this->buffer() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(4, this->_internal_buffer(), target);
  }
  ...
  if (!(this->dirty() <= 0 && this->dirty() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(19, this->_internal_dirty(), target);
  }

  // float writeback = 20;
  if (!(this->writeback() <= 0 && this->writeback() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(20, this->_internal_writeback(), target);
  }

  // float anon_pages = 21;
  if (!(this->anon_pages() <= 0 && this->anon_pages() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(21, this->_internal_anon_pages(), target);
  }

  // float mapped = 22;
  if (!(this->mapped() <= 0 && this->mapped() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(22, this->_internal_mapped(), target);
  }

  // float KReclaimable = 23;
  if (!(this->kreclaimable() <= 0 && this->kreclaimable() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(23, this->_internal_kreclaimable(), target);
  }

  // float sReclaimable = 24;
  if (!(this->sreclaimable() <= 0 && this->sreclaimable() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(24, this->_internal_sreclaimable(), target);
  }

  // float sUnreclaim = 25;
  if (!(this->sunreclaim() <= 0 && this->sunreclaim() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(25, this->_internal_sunreclaim(), target);
  }

  // float used_percent = 26;
  if (!(this->used_percent() <= 0 && this->used_percent() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(26, this->_internal_used_percent(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:monitor.proto.MemInfo)
  ...
  if (!(from.buffer() <= 0 && from.buffer() >= 0)) {
