...
class MemInfo :
 ...
 public:
  ...
  enum : int {
    ...
    kDirtyFieldNumber = 19,
    kWritebackFieldNumber = 20,
    kAnonPagesFieldNumber = 21,
    kMappedFieldNumber = 22,
    kKReclaimableFieldNumber = 23,
    kSReclaimableFieldNumber = 24,
    kSUnreclaimFieldNumber = 25,
    kUsedPercentFieldNumber = 26,
  };
  // float total = 1;
  void clear_total();
  float total() const;
  ...
  private:
  float _internal_buffer() const;
  void _internal_set_buffer(float value);
  public:
...
// float buffer = 4;
inline void MemInfo::clear_buffer() {
  buffer_ = 0;
}
inline float MemInfo::_internal_buffer() const {
  return buffer_;
}
inline float MemInfo::buffer() const {
  // @@protoc_insertion_point(field_get:monitor.proto.MemInfo.buffer)
  return _internal_buffer();
}
inline void MemInfo::_internal_set_buffer(float value) {
  
  buffer_ = value;
}
inline void MemInfo::set_buffer(float value) {
  _internal_set_buffer(value);
  // @@protoc_insertion_point(field_set:monitor.proto.MemInfo.buffer)
}
