...
class MonitorInfo :
 ...
 public:
  ...
  public:
  void clear_soft_irq();
  ::monitor::proto::CpuSoftirqs* mutable_soft_irq(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::monitor::proto::CpuSoftirqs >*
      mutable_soft_irq();
  private:
  const ::monitor::proto::CpuSoftirqs& _internal_soft_irq(int index) const;
  ::monitor::proto::CpuSoftirqs* _internal_add_soft_irq();
  public:
  const ::monitor::proto::CpuSoftirqs& soft_irq(int index) const;
  ::monitor::proto::CpuSoftirqs* add_soft_irq();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::monitor::proto::CpuSoftirqs >&
      soft_irq() const;
...
class RpcManager : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(RpcManager);
};

class RpcManager_Stub : public RpcManager {
 public:
  RpcManager_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  RpcManager_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(RpcManager_Stub);
};
...
inline ::monitor::proto::CpuSoftirqs* MonitorInfo::mutable_soft_irq(int index) {
  // @@protoc_insertion_point(field_mutable:monitor.proto.MonitorInfo.soft_irq)
  return soft_irq_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::monitor::proto::CpuSoftirqs >*
MonitorInfo::mutable_soft_irq() {
  // @@protoc_insertion_point(field_mutable_list:monitor.proto.MonitorInfo.soft_irq)
  return &soft_irq_;
}
inline const ::monitor::proto::CpuSoftirqs& MonitorInfo::_internal_soft_irq(int index) const {
  return soft_irq_.Get(index);
}
inline const ::monitor::proto::CpuSoftirqs& MonitorInfo::soft_irq(int index) const {
  // @@protoc_insertion_point(field_get:monitor.proto.MonitorInfo.soft_irq)
  return _internal_soft_irq(index);
}
inline ::monitor::proto::CpuSoftirqs* MonitorInfo::_internal_add_soft_irq() {
  return soft_irq_.Add();
}
inline ::monitor::proto::CpuSoftirqs* MonitorInfo::add_soft_irq() {
  // @@protoc_insertion_point(field_add:monitor.proto.MonitorInfo.soft_irq)
  return _internal_add_soft_irq();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::monitor::proto::CpuSoftirqs >&
